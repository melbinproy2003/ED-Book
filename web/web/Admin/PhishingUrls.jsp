...
<html lang="en" >
    <head>
        <meta charset="UTF-8">
        <title>Phishing Urls List</title>
    ...
    <body>
        <h1 align="center" id="heading">Phishing Urls List</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                    int i = 0;
                    String selQry = "select * from tbl_phishingurls";
                ...
                <tr>
                    <td><%=i%></td>
                    <td><%=rs.getString("phishing_date")%></td>
                    <td><%=rs.getString("phishing_url")%></td>
                </tr>
                <%
                    }
