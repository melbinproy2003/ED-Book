...
<html>
    ...
    <%        if (request.getParameter("btn_save") != null) {
            ...
            response.sendRedirect("ViewCollegeComplaint.jsp");
        }
                            ...
                            <div class="QA_section">
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int i = 0;
                                                String selQry = "select * from tbl_complaint c inner join tbl_college co on co.college_id=c.college_id where complaint_status='0'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs.getString("college_name")%></td>
                                                <td align="center"><a href="ViewCollegeComplaint.jsp?up=<%=rs.getString("complaint_id")%>" class="status_btn">Reply</a> </td>
                                            </tr>
                                            <%                      }
                                ...
                                <div class="QA_table mb_30">
                                    ...
                                    <table class="table lms_table_active">
                                        ...
                                        <tbody>
                                            <%                                                int j = 0;
                                                String selQry1 = "select * from tbl_complaint c inner join tbl_college co on co.college_id=c.college_id where complaint_status='1'";
                                            ...
                                            <tr>
                                                ...
                                                <td align="center"><%=rs1.getString("college_name")%></td>
