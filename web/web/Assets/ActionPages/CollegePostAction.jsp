...
//                        }
    ...
    String InsQry = "insert into tbl_post(post_file,post_content,post_date,college_id,post_status)"
            + "values('" + photo + "','" + value[0] + "',curdate(),'"+session.getAttribute("collegeid")+"','"+value[1]+"')";
...
<script type="text/javascript">
    alert("Posted");
    setTimeout(function() {
        window.location.href = '../../College/Homepage.jsp'
