...
//                        }
    ...
    String InsQry = "insert into tbl_post(post_file,post_content,post_date,teacher_id,post_status)"
            + "values('" + photo + "','" + value[0] + "',curdate(),'"+session.getAttribute("teacherid")+"','" + value[1] + "')";
