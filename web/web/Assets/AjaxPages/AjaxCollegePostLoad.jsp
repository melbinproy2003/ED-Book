...
<%
    String selQry = "select * from tbl_post where privacy_status in ('0','1','2','3','4') order by post_id desc";
    ...
    <div class="content-wrap">
        <div class="card-heading">
            <div class="user-block">
                <div class="image">
                    <img src="<%=rs.getString("university_photo")%>" alt="">
                </div>
                <div class="user-info">
                    <a href="#"><%=rs.getString("university_name")%></a>
            ...
            <div class="card-footer">
                ...
                <div class="social-count">
                    <div class="likes-count">
                        <%                            String zx1 = "select * from tbl_like where post_id='" + rs.getString("post_id") + "' and college_id='" + session.getAttribute("cid") + "'";
                    ...
                    <div class="media-content">
                        ...
                        <div class="actions">
                            <div class="image is-32x32">
                                <img class="is-rounded" style="width: 32px; height:32px " src="<%=session.getAttribute("cphoto")%>" data-user-popover="0" alt="">
                            </div>
                            <div class="toolbar">
    ...
    <div class="content-wrap">
        <div class="card-heading">
            ...
            <%
                ...
                if (rs.getString("college_id").equals(session.getAttribute("cid"))) {
            %>
            ...
            <div class="card-footer">
                <div class="media post-comment has-emojis">
                    ...
                    <div class="media-content">
                        ...
                        <div class="actions">
                            <div class="image is-32x32">
                                <img class="is-rounded" src="<%=session.getAttribute("cphoto")%>" data-user-popover="0" alt="">
                            </div>
                            <div class="toolbar">
                                <a class="button is-solid primary-button raised" onclick="comment(<%=rs.getString("post_id")%>)">Post Comment</a>
                            </div>
...
<%        }
    ...
    if (rs.getString("college_id").equals(session.getAttribute("cid"))) {
        if (rs.getString("department_id").equals("0")) {
            ...
            <div class="card-footer">
                ...
                <div class="likers-group">
                    ...
                    <img src="<%
                        if (!cvv.getString("college_photo").equals("0")) {
                            ...
                            out.println(cvv.getString("student_photo"));
                        }else if (!cvv.getString("university_photo").equals("0")) {
                            out.println(cvv.getString("university_photo"));
                        }
                ...
                <div class="likers-text">
                    <p>
                        ...
                        <%
                        }  else if (!cvv1.getString("university_name").equals("0")) {
                        %>

                        ,<a href="javascript:void(0)"><%=cvv1.getString("university_name")%></a>
