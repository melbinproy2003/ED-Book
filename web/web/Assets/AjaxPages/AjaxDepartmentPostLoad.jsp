...
<%
    String selQry = "select * from tbl_post where privacy_status in ('0','1','2','3','5','6') order by post_date desc";
            ...
            <div class="card-footer">
                ...
                <div class="social-count">
                    <div class="likes-count">
                        <%                            String zx1 = "select * from tbl_like where post_id='" + rs.getString("post_id") + "' and department_id='" + session.getAttribute("did") + "'";
                    ...
                    <div class="media-content">
                        ...
                        <div class="actions">
                            <div class="image is-32x32">
                                <img class="is-rounded" style="width: 32px; height:32px " src="<%=session.getAttribute("dphoto")%>" data-user-popover="0" alt="">
                            </div>
                            <div class="toolbar">
...
<%
    ...
    if (rs.getString("college_id").equals(session.getAttribute("dcid"))) {
            ...
            <div class="card-footer">
                <div class="media post-comment has-emojis">
                    ...
                    <div class="media-content">
                        ...
                        <div class="actions">
                            <div class="image is-32x32">
                                <img class="is-rounded" src="<%=session.getAttribute("dphoto")%>" data-user-popover="0" alt="">
                            </div>
                            <div class="toolbar">
                                <a class="button is-solid primary-button raised" onclick="comment(<%=rs.getString("post_id")%>)">Post Comment</a>
                            </div>
    ...
    <div class="content-wrap">
        <div class="card-heading">
            ...
            <%
                ...
                if (rs.getString("department_id").equals(session.getAttribute("did"))) {
            %>
