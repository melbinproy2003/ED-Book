...
<%
    String selQry = "select * from tbl_post where privacy_status in ('1','2','5') order by post_id desc";
            ...
            <div class="card-footer">
                ...
                <div class="social-count">
                    <div class="likes-count">
                        <%                            String zx1 = "select * from tbl_like where post_id='" + rs.getString("post_id") + "' and student_id='" + session.getAttribute("sid") + "'";
...
<%
    ...
    if (rs.getString("college_id").equals(session.getAttribute("scid"))) {
            ...
            <div class="card-footer">
                <div class="media post-comment has-emojis">
                    ...
                    <div class="media-content">
                        ...
                        <div class="actions">
                            <div class="image is-32x32">
                                <img class="is-rounded" src="<%=session.getAttribute("sphoto")%>" data-user-popover="0" alt="">
                            </div>
                            <div class="toolbar">
                                <a class="button is-solid primary-button raised" onclick="comment(<%=rs.getString("post_id")%>)">Post Comment</a>
                            </div>
    ...
    <div class="content-wrap">
        <div class="card-heading">
            ...
            <%
                ...
                if (rs.getString("student_id").equals(session.getAttribute("sid"))) {
            %>
...
<%
    ...
    if (rs.getString("department_id").equals(session.getAttribute("sdid"))) {
