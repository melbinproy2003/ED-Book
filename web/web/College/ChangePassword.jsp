...
<html>
    ...
    <%
     if(request.getParameter("submit")!=null){
         ...
         String select="select * from tbl_college where college_id='"+session.getAttribute("collegeid")+"'";
         ResultSet college=con.selectCommand(select);
         college.next();
         String curpass=college.getString("college_password");
         if(curpass.equals(request.getParameter("oldpassword"))){
             if(oldpass.equals(request.getParameter("newpassword"))){
                 ...
                 if(newpass.equals(request.getParameter("cpassword"))){
                     String up="update tbl_college set college_password='"+newpass+"' where college_id='"+session.getAttribute("collegeid")+"'";
