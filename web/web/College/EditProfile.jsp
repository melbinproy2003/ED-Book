...
<html>
    ...
    <%
        if (request.getParameter("btn_update") != null) {
            ...
            String upQry = "update tbl_college set "
                    + "college_name='" + request.getParameter("txt_name") + "', "
                    + "college_contact='" + request.getParameter("txt_number") + "',"
                    + "college_photo='" + request.getParameter("txt_pic") + "',"
                    + "college_email='" + request.getParameter("txt_email") + "'"
                    + "where college_id='" + session.getAttribute("cid") + "'";
        ...
        <div id="tab" align="center">
            ...
            <form method="post">
                <table border="1">
                    ...
                    %>
                    <tr>
                        <td colspan="2" align="center"><img id="img_pic" src="<%=rs.getString("college_photo")%>" style="border-radius: 50%" width="120" height="120">
                            ...
                            <input type="hidden" id="txt_pic" name="txt_pic">
                                ...
                                <tr>
                                    <td>Name</td>
                                    <td><input type="text" name="txt_name" value="<%=rs.getString("college_name")%>"></td>
                                </tr>
                                 <tr>
                                    <td>Contact</td>
                                    <td><input type="text" name="txt_number" value="<%=rs.getString("college_contact")%>"></td>
                                </tr>
                                 <tr>
                                    <td>Email</td>
                                    <td><input type="email" name="txt_email" value="<%=rs.getString("college_email")%>"></td>
                                </tr>
                                <tr>
