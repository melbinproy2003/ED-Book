        ...
        <div class="sidebar-v1 is-fold">
            <div class="top-section">
                ...
                <div class="user-block">
                    <img class="avatar" src="<%=session.getAttribute("cphoto")%>" alt="">
                    <div class="meta">
                        <span style="margin-left: 7px"><%=session.getAttribute("cname")%></span>
                        <span style="margin-left: 10px">College</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="controls">
                                    ...
                                    <div class="nav-drop-body is-friend-requests">
                                        ...
                                        <div class="media">
                                            <div class="media-content">
                                                <a href="ViewDepartmentComplaint.jsp">Department Complaint</a>
                                            </div>
                                            <div class="media-right is-centered">
                                                <div class="added-icon">
                                                    <a href="ViewDepartmentComplaint.jsp" > <i data-feather="alert-circle"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="media">
                                            <div class="media-content">
                                                <a href="ViewFeedBack.jsp">Department Feedback</a>
                                            </div>
                                            <div class="media-right is-centered">
                                                <div class="added-icon">
                                                    <a href="ViewFeedBack.jsp" > <i data-feather="alert-triangle"></i></a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="nav-drop is-right "  style="width: 250px">
                                <div class="inner">
                                    ...
                                    <div class="nav-drop-body is-friend-requests">
                                        ...
                                        <div class="media">
                                            <div class="media-content">
                                                <a href="DepartmentChat/Chat.jsp">Department</a>
                                            </div>
                                            <div class="media-right is-centered">
                                                <div class="added-icon">
                        ...
                        <div id="account-dropdown" class="navbar-item is-account drop-trigger has-caret">
                            <div class="user-image">
                                <img src="<%=session.getAttribute("cphoto")%>" alt="">
                                <span class="indicator"></span>
                            </div>
                            ...
                            <div class="nav-drop is-account-dropdown">
                                <div class="inner">
                                    <div class="nav-drop-header">
                                        <span class="username"><%=session.getAttribute("cname")%></span>
                                    ...
                                    <div class="nav-drop-body account-items">
                                        <a id="profile-link" href="ViewProfile.jsp" class="account-item">
                                            <div class="media">
                                                ...
                                                <div class="media-content">
                                                    <h3><%=session.getAttribute("cname")%></h3>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="hidden-options">
                                            <div class="target-channels" required>
                                                <!-- Publication Channel -->
                                                <div class="channel" onclick="checkOnlyOne(this.value);" value="1">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input class="checks" type="checkbox" id="checkbox-1" name="check_sel" value="1">
                                                    ...
                                                    <div class="channel-name">Everyone</div>
                                                </div>
                                                <div class="channel" onclick="checkOnlyOne(this.value);" value="2">
                                                    ...
                                                    <div class="channel-name">Only For College Members</div>
                                                </div>
                                                <div class="channel" onclick="checkOnlyOne(this.value);" value="3">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input class="checks" type="checkbox" id="checkbox-1" name="check_sel" value="3">
                                                            <label for="checkbox-1"></label>
                                                        </div>
                                                    </div>
                                                    <div class="channel-icon">
                                                    ...
                                                    <div class="channel-name">Only for College Departments</div>
                                                </div>
                                                <div class="channel" onclick="checkOnlyOne(this.value);" value="4">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input class="checks" type="checkbox" id="checkbox-1" name="check_sel" value="4">
                                                            <label for="checkbox-1"></label>
                                                        </div>
                                                    </div>
                                                    <div class="channel-icon">
                                                    ...
                                                    <div class="channel-name">Only For College Teachers</div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="column is-4">
                            ...
                            <div class="card">
                                <div class="card-heading is-bordered">
                                    ...
                                    <div class="dropdown is-spaced is-neutral is-right dropdown-trigger">
                                        <div>
                                            <div class="button">
                                                <a href="DepartmentList.jsp" >  <i data-feather="more-vertical"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body no-padding">
                                    ...
                                    <div class="story-block">
                                        <a href="NewDepartment.jsp" class="add-story">
                                    ...
                                    <!-- Story block -->
                                    <%
                                        String selQry = "select * from tbl_department d inner join tbl_department_type dt on d.department_type_id = dt.department_type_id where college_id='" + session.getAttribute("cid") + "'";
                                    ...
                                    <div class="story-block">
                                        <div class="img-wrapper">
                                            <img src="<%=rs.getString("department_photo")%>" data-user-popover="1" alt="">
                                        </div>
                                        <div class="story-meta">
                                            <span><%=rs.getString("department_type_name")%></span>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <%                                        String selQry2 = "select * from tbl_student s inner join tbl_course c on c.course_id=s.course_id inner join tbl_department d on d.department_id=s.department_id where college_id='" + session.getAttribute("cid") + "'";
                                    ...
                                    <div class="story-block">
                                        <div class="img-wrapper">
                                            <img src="<%=rs2.getString("student_photo")%>" data-user-popover="1" alt="">
                                        </div>
                                        <div class="story-meta">
                                            <span><%=rs2.getString("student_name")%></span>
                                        </div>
                                    </div>
        ...
        <script>
                                    ...
                                    function insPost()
                                    {
                                        ...
                                        if (div.trim() === "")
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxCollegePost.jsp',
                                    ...
                                    function loadPage()
                                    {
                                        $("#post-load").load('../Assets/AjaxPages/AjaxCollegePostLoad.jsp');
                                    }
                                    ...
                                    function onLike(img)
                                    {
                                        ...
                                        if (name === 'heart-b.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxCollegeLike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                        ...
                                        else if (name === 'heart-r.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxCollegeDislike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                    ...
                                    function comment(id)
                                    {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '../Assets/AjaxPages/AjaxCollegeComment.jsp',
                                            data: {id: id,
                                                content: content},
                                            success: function(result) {
                                                loadPage();
