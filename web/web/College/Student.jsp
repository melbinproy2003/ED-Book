...
<html lang="en" >
    ...
    <body>
<h1 align="center" id="heading">Student Data</h1>
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                 <%
                                                int i = 0;
                                                String selQry = "select * from tbl_student s inner join tbl_place p on p.place_id=s.place_id inner join tbl_district dis on dis.district_id=p.district_id inner join tbl_course co on co.course_id=s.course_id inner join tbl_department d on d.department_id=s.department_id inner join tbl_college c on c.college_id=d.college_id where d.college_id='"+session.getAttribute("cid")+"'";
