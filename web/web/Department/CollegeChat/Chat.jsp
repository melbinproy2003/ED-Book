            ...
            <div class="chat-inner">
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" src="<%=session.getAttribute("dcphoto")%>" alt="">
                            </div>
                            <div class="username">
                                <span><%=session.getAttribute("dcname")%>(College Group)</span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
                ...
                <div id="chat-sidebar" class="users-sidebar">   
                    ...
                    <div class="conversations-list has-slimscroll-xs">
                        ...
                        <div class="user-item">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 32px; height:32px " src="<%=session.getAttribute("dcphoto")%>" alt="">
                            </div>
                        </div>
                        <%
                            String selQry = "select * from tbl_department where college_id='" + session.getAttribute("dcid") + "'";
                            ResultSet rs = con.selectCommand(selQry);
                            while (rs.next()) {
                        %>
                        <div class="user-item">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 32px; height:32px " src="<%=rs.getString("department_photo")%>" alt="">
                            </div>
                        </div>
                        <%
                            }
