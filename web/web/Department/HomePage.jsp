<%-- 
    Document   : HomePage
    Created on : 16 Dec, 2023, 4:20:12 PM
    Author     : MELBIN
--%>
...
<html>
    <head>
        ...
        <title><%=session.getAttribute("departmentname")%> HomePage</title>
    </head>
    <body align="center">
        <h1><%=session.getAttribute("departmentname")%></h1>
        <a href="DepartmentProfile.jsp"><button>Profile</button></a>
        <a href="NewStudent.jsp"><button>Add Student</button></a>
        <a href="ListofTeachers.jsp"><button>List Teachers</button></a>
        <a href="DepartmentPost.jsp"><button>Add Post</button></a>
        <br><br>
        <%
