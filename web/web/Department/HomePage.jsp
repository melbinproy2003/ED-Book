        ...
        <script>
                                    ...
                                    function insPost()
                                    {
                                        ...
                                        if (div.trim() === "")
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxDepartmentPost.jsp',
                                    ...
                                    function loadPage()
                                    {
                                        $("#post-load").load('../Assets/AjaxPages/AjaxDepartmentPostLoad.jsp');
                                    }
                                    ...
                                    function onLike(img)
                                    {
                                        ...
                                        if (name === 'heart-b.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxDepartmentLike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                        ...
                                        else if (name === 'heart-r.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxDepartmentDislike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                    ...
                                    function comment(id)
                                    {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '../Assets/AjaxPages/AjaxDepartmentComment.jsp',
                                            data: {id: id,
                                                content: content},
                                            success: function(result) {
                                                loadPage();
