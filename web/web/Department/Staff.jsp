...
<html lang="en" >
    ...
    <body>
        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            ...
            <tbody>
                <%                   int i = 0;
                    String selQry = "select * from tbl_teacher t inner join tbl_department d on d.department_id=t.department_id inner join tbl_college c on c.college_id=d.college_id inner join tbl_place p on p.place_id=t.place_id inner join tbl_district dis on dis.district_id=p.district_id where t.department_id='"+session.getAttribute("did")+"'";
