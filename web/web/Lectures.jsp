    ...
    <body>
        <div id="tab" align="center">
            ...
            <table>
                ...
                int i = 0;
                    String selQry1 = "select * from tbl_lecture l inner join tbl_subject s on s.subject_id=l.subject_id inner join tbl_teacher t on t.teacher_id=l.teacher_id where s.semester_id = '" + session.getAttribute("ssid") + "'";
