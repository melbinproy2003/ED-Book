            ...
            <div class="chat-inner">
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 42px; height:42px " src="<%=session.getAttribute("sdphoto")%>" alt="">
                            </div>
                            <div class="username">
                                <span><%=session.getAttribute("sdname")%>(Department Group)</span>
                            </div>
                        </div>
                    </div>
                    <div class="nav-end">
                ...
                <div id="chat-sidebar" class="users-sidebar">   
                    ...
                    <div class="conversations-list has-slimscroll-xs">
                        ...
                        <div class="user-item">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 32px; height:32px "  src="<%=session.getAttribute("sdphoto")%>" alt="">
                            </div>
                        </div>
                        <%
                        ...
                        <%
                            ...
                            String selQry1 = "select * from tbl_student where department_id='" + session.getAttribute("sdid") + "'";
