<%-- 
    Document   : Homepage
    Created on : 18 Dec, 2023, 10:17:22 AM
    Author     : MELBIN
--%>
...
<html>
    ...
    <body align="center">
        <h1><%out.print(session.getAttribute("studentname"));%></h1>
        <a href="Studentprofile.jsp"><button>Profile</button></a>
        <a href="ViewLecture.jsp"><button>Notes</button></a>
        <br><br>
        <%
