...
<html>
    ...
    <%
     if(request.getParameter("submit")!=null){
         ...
         teacher.next();
         String curpass=teacher.getString("teacher_password");
         if(curpass.equals(request.getParameter("oldpassword"))){
             if(oldpass.equals(request.getParameter("newpassword"))){
                 ...
                 if(newpass.equals(request.getParameter("cpassword"))){
                     String up="update tbl_teacher set teacher_password='"+newpass+"' where teacher_id='"+session.getAttribute("teacherid")+"'";
