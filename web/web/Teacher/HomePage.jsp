                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="hidden-options">
                                            <div class="target-channels" required>
                                                ...
                                                <div class="channel" onclick="checkOnlyOne(this.value);" value="6">
                                                    <div class="round-checkbox is-small">
                                                        <div>
                                                            <input class="checks" type="checkbox" id="checkbox-1" name="check_sel" value="6">
                                                            <label for="checkbox-1"></label>
                                                        </div>
                                                    </div>
                                                    <div class="channel-icon">
                                                    ...
                                                    <div class="channel-name">Only for Department Teachers</div>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="column is-4">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <%
                                        ...
                                        String selQry = "select * from tbl_teacher where department_id='" + session.getAttribute("tdid") + "'";
                            ...
                            <div class="card">
                                ...
                                <div class="card-body no-padding">
                                    ...
                                    <!-- Story block -->
                                    <%                                        String selQry1 = "select * from tbl_student s inner join tbl_course c on c.course_id = s.course_id where department_id='" + session.getAttribute("tdid") + "'";
        ...
        <script>
                                    ...
                                    function insPost()
                                    {
                                        ...
                                        if (div.trim() === "")
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxTeacherPost.jsp',
                                    ...
                                    function loadPage()
                                    {
                                        $("#post-load").load('../Assets/AjaxPages/AjaxTeacherPostLoad.jsp');
                                    }
                                    ...
                                    function onLike(img)
                                    {
                                        ...
                                        if (name === 'heart-b.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxTeacherLike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                        ...
                                        else if (name === 'heart-r.svg')
                                        {
                                            ...
                                            $.ajax({
                                                type: 'POST',
                                                url: '../Assets/AjaxPages/AjaxTeacherDislike.jsp',
                                                data: {id: id},
                                                success: function(result) {
                                                    loadPage();
                                    ...
                                    function comment(id)
                                    {
                                        ...
                                        $.ajax({
                                            type: 'POST',
                                            url: '../Assets/AjaxPages/AjaxTeacherComment.jsp',
                                            data: {id: id,
                                                content: content},
                                            success: function(result) {
                                                loadPage();
