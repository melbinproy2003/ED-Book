    ...
    <body>
        ...
        <div class="chat-wrapper is-standalone">
            <div class="chat-inner">
                ...
                <%
                    String selQr = "select * from tbl_student where student_id='" + request.getParameter("sid") + "'";
                    ...
                    <div class="nav-start">
                        <div class="recipient-block">
                            <div class="avatar-container">
                                <img class="user-avatar" style="width: 42px; height:42px " src="<%=rs.getString("student_photo")%>" alt="">
                            </div>
                            <div class="username">
                    ...
                    <div class="chat-action">
                        <div class="chat-action-inner">
                            <div class="control" style="text-align: center">
                                ...
                                <input type="hidden" name="txt_hid" id="txt_hid" value="<%=request.getParameter("sid")%>"/>
