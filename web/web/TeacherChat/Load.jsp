...
<%
    String selQry = "select * from tbl_teacher_student_chat tsc inner join tbl_student t on (tsc.to_student_id=t.student_id) or (tsc.from_student_id=t.student_id) where t.student_id='" + request.getParameter("uid") + "' order by chat_id";
    //System.out.println(selQry);
    ResultSet rs = con.selectCommand(selQry);
    while (rs.next()) {

        if (rs.getString("to_teacher_id").equals(request.getParameter("tid"))) {
...
} else if (rs.getString("from_teacher_id").equals(request.getParameter("tid"))) {
